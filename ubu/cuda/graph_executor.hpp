...
class graph_executor
{
  public:
    ...
    event_type bulk_execute_after(const event_type& before, coordinate_type shape, F f) const
    {
    ...
    event_type execute_after(const event_type& before, F f) const
    {
