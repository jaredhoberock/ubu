...
class lattice
{
  public:
    ...
    {
      return ASPERA_NAMESPACE::grid_size(shape());
    }
...
class lattice_iterator
{
  ...
  private:
    ...
    {
      current_ = domain_.origin() + ASPERA_NAMESPACE::colexicographic_index_to_grid_coordinate(colexicographic_index() + n, domain_.shape());
    }
    ...
    constexpr difference_type colexicographic_index() const
    {
      ...
      return ASPERA_NAMESPACE::colexicographic_index(idx, domain_.shape());
    }
