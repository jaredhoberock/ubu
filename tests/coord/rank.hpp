...
void test_rank()
{
  ...
  static_assert(0 == ns::rank_v<int>);
  static_assert(0 == ns::rank(13));
  static_assert(0 == ns::rank_v<unsigned int>);
  static_assert(0 == ns::rank(13u));
  static_assert(0 == ns::rank_v<std::size_t>);
  static_assert(0 == ns::rank(std::size_t{13}));
  ...
  static_assert(0 == ns::rank_v<int&>);
  static_assert(0 == ns::rank_v<const unsigned int&>);
  static_assert(0 == ns::rank_v<std::size_t&&>);
  static_assert(1 == ns::rank_v<const std::tuple<char>&>);

  static_assert(0 == ns::rank_v<float>);
  static_assert(0 == ns::rank(3.14f));
  static_assert(0 == ns::rank_v<double>);
  static_assert(0 == ns::rank(3.14));
