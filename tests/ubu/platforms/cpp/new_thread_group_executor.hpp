...
#include <ubu/places/execution/executor/concepts/bulk_executable_on.hpp>
#include <ubu/places/execution/executor/concepts/bulk_executable_with_workspace_on.hpp>
