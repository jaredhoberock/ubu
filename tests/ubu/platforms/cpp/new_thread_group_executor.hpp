...
#include <ubu/places/execution/executors/concepts/bulk_executable_on.hpp>
#include <ubu/places/execution/executors/concepts/bulk_executable_with_workspace_on.hpp>
